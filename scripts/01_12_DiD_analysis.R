...
rds_files <- list(
  Overall =  "data/scratch/est_cs_total_robust_universal.RDS",
  Electricity = "data/scratch/est_cs_elec_robust_universal.RDS",
  Gas = "data/scratch/est_cs_gas_robust_universal.RDS"
)
