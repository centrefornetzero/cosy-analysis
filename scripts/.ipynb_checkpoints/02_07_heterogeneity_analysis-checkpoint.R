...
income <- readxl::read_excel(file.path("input/saiefy1920finalqaddownload280923.xlsx", sheet = "Total annual income", skip = 4)) %>%
...
# Create unique breaks for predicted_heatloss_watts
income_dist <- readxl::read_excel(file.path("input/saiefy1920finalqaddownload280923.xlsx", sheet = "Total annual income", skip = 4)) %>%
  select(`MSOA code`, `Total annual income (£)`) 
